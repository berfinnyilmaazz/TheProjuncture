...
export const registerUser = async (req, res) => {
    try {
        const {name, email, password, telephone, location, isAdmin, role, title, bio} = req.body;
    ...
    try {
        ...
        const id = 
            ...
            if(user) {
                ...
                req.body.showSocialLinks !== undefined
                ? req.body.showSocialLinks
                : user.showSocialLinks;

                user.showEmail = req.body.showEmail ?? user.showEmail;
                user.showTelephone = req.body.showTelephone ?? user.showTelephone;
                user.showLocation = req.body.showLocation ?? user.showLocation;
